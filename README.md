...
* 🎯 ATS Score Engine — paste any job description to get a match score, keyword gap analysis, section-level feedback, and improvement suggestions
* 🛡️ Rate limiting — general API protection (100 req/15 min) and strict AI route limiting (10 req/min per user) to prevent abuse
